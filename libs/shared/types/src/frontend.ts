/**
 * libs/shared/types/src/frontend.ts
 *
 * Frontend-compatible copies of shared enums and types.
 * Next.js cannot directly import from TypeScript backend libs,
 * so we provide plain JS const objects that mirror @claims/shared/enums.
 *
 * IMPORTANT: Keep in sync with libs/shared/enums/src/index.ts
 */
...
// Convenience arrays for dropdowns
